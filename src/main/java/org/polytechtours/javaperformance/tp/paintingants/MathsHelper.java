...
public class MathsHelper {
	...
	// =========================================================================
	  ...
	  protected void readParameterFourmis(Vector<CFourmi> mColonie,  CColonie mColony, CPainting mPainting, PaintingAnts paintingAnts) {
	    String lChaine;
	    int R, G, B;
	    ...
	    lChaine = paintingAnts.getParameter("SeuilLuminance");
	    if (lChaine != null) {
	    ...
	    lChaine = paintingAnts.getParameter("NbFourmis");
	    if (lChaine != null) {
	    ...
	    lChaine = paintingAnts.getParameter("Fourmis");
	    if (lChaine != null) {
